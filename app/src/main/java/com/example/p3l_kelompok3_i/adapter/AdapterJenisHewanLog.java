...
public class AdapterJenisHewanLog extends RecyclerView.Adapter<AdapterJenisHewanLog.HolderData> implements Filterable {
    ...
    public AdapterJenisHewanLog(Context ctx, List<DataJenisHewan> mList)
    {
        this.ctx = ctx;
        this.mList= mList;
    ...
    @NonNull
    @Override
    public AdapterJenisHewanLog.HolderData onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.layoutjenishewan,parent,false);
        AdapterJenisHewanLog.HolderData holder = new AdapterJenisHewanLog.HolderData(layout);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterJenisHewanLog.HolderData holder, int position) {
