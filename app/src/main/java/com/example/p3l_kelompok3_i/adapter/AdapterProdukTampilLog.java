...
public class AdapterProdukTampilLog extends RecyclerView.Adapter<AdapterProdukTampilLog.HolderData> implements Filterable {
    ...
    public AdapterProdukTampilLog(Context ctx, List<DataProduk> mList) {
        this.ctx = ctx;
        this.mList = mList;
    ...
    public HolderData onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.layoutproduklog, parent, false);
    ...
    public void onBindViewHolder(@NonNull HolderData holder, int position) {
        ...
        holder.deletedDate.setText(String.valueOf(dp.getDeleted_date()));
    ...
    class HolderData extends RecyclerView.ViewHolder {
        TextView namaProduk, hargaProduk, stokProduk, stokMinimalProduk, idProduk,deletedDate;
        ...
        public HolderData(View v) {
            ...
            deletedDate  = (TextView) v.findViewById(R.id.tvDeletedDateProduk);
