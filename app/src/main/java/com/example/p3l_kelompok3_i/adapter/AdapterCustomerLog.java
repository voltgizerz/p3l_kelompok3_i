...
public class AdapterCustomerLog   extends RecyclerView.Adapter<AdapterCustomerLog.HolderData> implements Filterable {
    ...
    public AdapterCustomerLog(Context ctx, List<DataCustomer> mList)
    {
        this.ctx = ctx;
        this.mList= mList;
    ...
    @NonNull
    @Override
    public AdapterCustomerLog.HolderData onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.layoutcustomer,parent,false);
        AdapterCustomerLog.HolderData holder = new AdapterCustomerLog.HolderData(layout);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterCustomerLog.HolderData holder, int position) {
