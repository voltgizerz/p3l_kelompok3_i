...
public class AdapterUkuranHewanLog extends RecyclerView.Adapter<AdapterUkuranHewanLog.HolderData> implements Filterable {
    ...
    public AdapterUkuranHewanLog(Context ctx, List<DataUkuranHewan> mList)
    {
        this.ctx = ctx;
        this.mList= mList;
    ...
    @NonNull
    @Override
    public AdapterUkuranHewanLog.HolderData onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.layoutukuranhewan,parent,false);
        AdapterUkuranHewanLog.HolderData holder = new AdapterUkuranHewanLog.HolderData(layout);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterUkuranHewanLog.HolderData holder, int position) {
